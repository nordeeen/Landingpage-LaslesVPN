...
const About = () => {
  return (
    <>
      <section className="max-w-full h-auto bg-[#F6F6F6] pt-[100px] py-4 sm:overflow-x-hidden">
        <div className="flex justify-center sm:flex-col-reverse">
          <div className="flex flex-col justify-center">
            <div className="w-[555px] h-[140px] sm:max-w-full sm:px-4 sm:pt-10">
            ...
            <div className="w-[555px] h-[60px] mt-[20px] sm:max-w-full sm:px-4">
            ...
            <div className="mt-[50px] text-white sm:flex sm:justify-center sm:pt-3">
              <button className="w-[250px] h-[60px] bg-[#F53838] rounded-[10px] text-[16px] leading-[25px] font-bold shadow-md shadow-gray-400 hover:-translate-y-1 hover:transition-all">
                Get Started
              </button>
            </div>
          </div>
          ...
          <div className="space-x-10">
            <LazyLoadImage
              ...
              className="w-[38.203rem] h-[23.903rem] object-contain sm:max-w-full sm:h-auto"
            />
          </div>
        </div>
      </section>
